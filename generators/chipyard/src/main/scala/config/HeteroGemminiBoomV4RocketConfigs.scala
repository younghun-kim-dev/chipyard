...
import freechips.rocketchip.subsystem.{ WithNMemoryChannels, WithInclusiveCache, WithNBanks }
/** -----------------------------------------------------------
...
class GemminiLargeBoomV4Rocket22CHConfig extends Config(
  new DefaultGemminiConfig ++
...
class GemminiLargeBoomV4Rocket22CHL24BanksConfig extends Config(
  new DefaultGemminiConfig ++
  new WithNMemoryChannels(2) ++
  new WithNBanks(4) ++
  new WithNBigCores(2) ++
